...
describe('Static Injections', function () {
  ...
  function assertions(res) {
    ...
    assert.deepEqual(res.locals.pageInjections.bodyEndScripts, [{
      async: true,
      src: '/beep/boop.js'
    }]);
    assert.deepEqual(res.locals.pageInjections.headLinks, [{
      rel: 'stylesheet',
      href: '/beep/boop.css'
    }]);
    res.locals = {};
...
//# sourceMappingURL=staticInjections-test.js.map