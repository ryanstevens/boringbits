...
module.exports = {  
  ...
  app_build: getProjPath('paths.app_build', 'build'),
  app_dist: getProjPath('paths.app_dist', 'dist'),
  app_config: getProjPath('paths.app_config', 'config'),
  app_src: getProjPath('paths.app_src', 'src/client'),  
  app_node_modules: getProjPath('paths.node_modules', 'node_modules'),
  app_package_json: getProjPath('paths.package_json', 'package.json'),
  app_dir: getProjPath(base_app_path_key, base_app_path),

  server_routers: getAppDirPath('paths.server_routers', '/server/routers'),
  ...
  boring_routers: getBoringPath('paths.boring_routers', '/src/lib/init-routers/core-routers'),
