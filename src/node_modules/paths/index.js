...
module.exports = {
  ...
  boring_routers: getBoringPath('boring.paths.boring_routers', `/${base_app_path}/lib/init-routers/core-routers`),
  boring_middleware: getBoringPath('boring.paths.boring_middleware', `/${base_app_path}/lib/init-middleware/core-middleware`),
  boring_hooks: getBoringPath('boring.paths.boring_hooks', `/${base_app_path}/lib/init-hooks/core-hooks`),
